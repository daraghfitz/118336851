...
<body id="page-top">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Education/Work Experience</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">Personal Details</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
  ...
  <section class="portfolio" id="portfolio">
    <div class="container">
      <h2 class="text-center text-uppercase text-secondary mb-0">Education/Work Experience</h2>
  ...
  <section class="bg-primary text-white mb-0" id="about">
    <div class="container">
      <h2 class="text-center text-uppercase text-white">Personal Details</h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto">
            <p class="lead">Daragh Fitzgerald<br>
                07/01/2000<br>
                da******@l***.ie<br>
                08714*****<br>
                11 Cl** D***<br>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 mb-5 mb-lg-0">
          <h4 class="text-uppercase mb-4">IS1113 Project</h4>
